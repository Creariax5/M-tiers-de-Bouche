...
const Sidebar = () => {
  ...
  const isActive = (path) => {
    return location.pathname === path ? 'bg-night-bordeaux text-white' : 'text-stone-brown hover:bg-white-smoke';
  };

  return (
    <div className="w-64 h-screen bg-white border-r border-gray-200 fixed left-0 top-0 overflow-y-auto font-secondary">
      <div className="p-6 border-b border-gray-100">
        <Link to="/" className="block">
          <h1 className="font-primary text-2xl text-night-bordeaux">REGAL</h1>
          <p className="text-xs text-stone-brown mt-1 tracking-widest uppercase">Design System</p>
        </Link>
      </div>

      <nav className="p-4">
        <div className="mb-8">
          <h2 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 px-4">Fondamentaux</h2>
